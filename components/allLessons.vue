    ...
    <div class="space">
      ...
      <div class="flex justify-center">
        <ul class="grid-container pt-8 pb-20">
          <li v-for="sub in category.subCategories" :key="sub.id" :class="{'excluded-page': isExcluded(sub.slug)}" class="grid-item rounded-3xl bg-[#BADBE7]">
...
const excludedSlugs = ["notaris", "btw_aanvraag", "sociaal_secretariaat", "vergunning", "eenmans_vennootschap", "jaarrekening_pb_vb"];
...
.excluded-page {
  filter: brightness(0.5); /* Donkere filter toevoegen */
}
